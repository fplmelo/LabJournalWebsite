...
- Bases de dados ecológicos seguem uma lógica relativamente simples
  - As bases são organizadas quse sempre na forma de matrizes com 'n' colunas e 'm' linhas
...
```{r, echo=FALSE}
load("/home/felipe/Google Drive/github/ecologia_numerica/00_aula1_basesdados/NEwR-2ed_code_data/NEwR2-Data/Doubs.RData")
head(spe)
```

...
xaringanExtra::embed_xaringan(url="https://fplmelo.github.io/eco_numerica/slides/aula3_cluster.html#1", ratio = "16:9")
...
1) Use a base "spe" e tente econtrar grupos de amostras (comunidades) que pertencem à trechos específicos do rio.
  1.1) teste tanto medidas de distância quanto métodos de agrupamento diferentes

2) Use métodos de K-means para encontrar quantos clusters há de fato segundo o método "silhouette"
  2.2) grafique o o rio colorindo as amostras segundo seu pertencimento aos clusters gerados
  
  como esse aqui
  ![](https://fplmelo.github.io/eco_numerica/images/doubs_river.png)

3) Avalie com gráficos de boxplot como os clusters são diferenciados em termos ambientais (base "env")

Comente os resltados brevemente, tentando interpretar os resultados biológicos.

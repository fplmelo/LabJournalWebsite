...
```{r, echo=FALSE}
xaringanExtra::embed_xaringan(url = "https://fplmelo.github.io/eco_numerica/docs/slides/slides_aula1.html#1", ratio = "16:9")
...
Agora, crie suas próprias perguntas e explore os dados. Lembre-se, são dados de uma comunidade de peixes amostradas em 30 localidades de um rio qualquer. Temos tanto a localização geográfica dessas amostras quanto as características ambientais do rio nessas localidades.
